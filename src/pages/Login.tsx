...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-600 via-indigo-700 to-indigo-900 relative overflow-hidden">
      {/* Decorative blobs */}
      ...
      <div className="absolute top-1/2 left-1/2 w-72 h-72 bg-teal-500 rounded-full opacity-5 blur-3xl -translate-x-1/2 -translate-y-1/2" />
        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-white rounded-2xl shadow-2xl p-8">
            ...
            <button
              ...
              disabled={loading}
              className="w-full flex items-center justify-center gap-3 bg-gray-50 border border-gray-200 text-gray-700 py-2.5 rounded-xl hover:bg-gray-100 active:scale-[0.98] transition-all disabled:opacity-60"
            >
