  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-indigo-50 flex items-center justify-center">
        <div className="animate-pulse text-indigo-600 font-medium">Loading your history...</div>
      </div>
    )
  }
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-indigo-50 flex items-center justify-center px-4">
        <div className="text-center">
          ...
          <h2 className="text-lg font-semibold text-gray-900 mb-2">No measurements yet</h2>
          <p className="text-sm text-gray-500 mb-4">Take your first measurement to start tracking</p>
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-indigo-50 py-8 px-4">
      <div className="max-w-lg mx-auto">
        <div className="flex items-center justify-between mb-6">
          <div>
            <h1 className="text-xl font-bold text-gray-900">Measurement History</h1>
                  ...
                  <div className="grid grid-cols-3 gap-2">
                    {[
                      ...
                      <div key={label} className={`text-center py-1.5 rounded-lg ${i === 0 ? 'bg-indigo-50' : 'bg-gray-50'}`}>
                        ...
                        <p className="text-[10px] text-gray-400">{label} (cm)</p>
                      </div>
                    ))}
                  </div>
                </div>
        ...
        <div className="mt-6 flex items-center justify-center gap-2 text-xs text-gray-400">
          <TrendingUp className="w-3 h-3" /> Keep tracking for better insights
        </div>
      </div>
    </div>
  )
